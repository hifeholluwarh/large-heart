...
if($download)
{
	...
	$start=$_GET['start'];  $end=$_GET['end']; $dept=$_GET['dept'];
        ...
        <td align="center"><p class="style7"><?php echo $hd;?></p>
          <table width="795" height="26" border="1" align="center" cellpadding="5" cellspacing="0">
            <tr bgcolor="green" class="textonly3">
			  ...
			  <td width="59" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Date</strong></div></td>
			  <td width="89" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Department </strong></div></td>
			  <td width="124" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Description</strong></div></td>
			  <td width="165" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Note</strong></div></td>
			  <td width="49" align="center" bgcolor="#000"><div align="center" class="style9"><strong>Qty</strong></div></td>
			  <td width="95" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Priority </strong></div></td>
			  <td width="33" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Order</strong></div></td>
<? if(!$download){ ?><td width="49" align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Status</strong></div></td>
<? } ?>            </tr>
<?php
	if($dept) 
	{
		if($rept=="aa") $add_this="where dept='$dept'";
		else $add_this="and dept='$dept'";
	}
	$datd="$y-$m1-$d"; $datm="$y-$m1"; $daty="$y";
	$tb_name="purchase_request";
	...
	if($num_results>=1)
	{
		for($i=1; $i<=$num_results; $i++) 
		{
			...
			echo "<td>".$rows["pdat"]."</td>";
			$id=$rows["id"];
			echo "<td bgcolor=#009900><a href='view_purchase_request.php?id=$id' target='_blank'>".$rows["ord_no"]."</td>";	
		 if(!$download){
			echo "<td bgcolor='$bg' align='center'>";
				if($status=='Treated') echo "<img src='T.jpg' width='20' height='20'>";
				elseif($status=='Pending') echo "<img src='P.jpg' width='20' height='20'></td>";  }
			echo "</tr>";
		}
	}
