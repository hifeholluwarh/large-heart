...
if($Submit=="Update Client")
{

	$dat=date('Y-m-d');
	$result=mysql_query("update clients set company='$company',address='$address',phone='$phone',email='$email' where id='$id'");
	$msg="Clients Detail has been successfully updated!"; 
...
<table width="100%" height="181" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <td height="13" valign="middle" class="textonly3"><p align="center" class="title style6"><strong>Edit Client</strong></p>
          <hr /></td>
  </tr>
  <tr>
    <td height="157" align="center" valign="top"><form id="form1" name="form1" method="post" action="">
        ...
        <table width="441" height="270" border="0" align="center" cellpadding="0" cellspacing="0" class="textonly3">
          <tr>
            ...
            <td valign="middle">
              <div align="left">
               <font size='4'> <?php echo $company;?> <input name="company" type="hidden" class="inputs" id="company"  value="<?php echo $company;?>" />
              </div>            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td valign="middle"><div align="left">
              <input name="Submit" type="submit" class="inputs-focus" value="Update Client" />
            </div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
      ...
      <table width="95%" height="26" border="1" align="center" cellpadding="5" cellspacing="0">
        <tr bgcolor="green" class="textonly3">
          ...
          <td width="174" align="center" bgcolor="#000"><div align="center" class="style9"><strong>Name/Company</strong></div></td>
          <td width="90" align="center" bgcolor="#000"><div align="center" class="style9"><strong>Phone No. </strong></div></td>
          <td width="71" align="center" bgcolor="#000"><div align="center" class="style9"><strong>E-mail Address </strong></div></td>
	...
	for($i=1; $i<=$num_results; $i++) 
   	{
		...
		echo "<td align=center><a href='main.php?page=edit_clients&id=$id'>
