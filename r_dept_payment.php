...
<table width="100%" height="181" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <td height="13" valign="middle" class="textonly3"><p align="center" class="title style6"><strong>Payment of Debts</strong></p>
          <hr /></td>
  </tr>
  <tr>
    <td height="157" align="center" valign="top"><form id="form1" name="form1" method="post" action="main.php?page=r_dept_payment">
	  ...
	  <?php 
		...
		elseif($m=="Dec") $m1="12";
			...
			if ($rept=="dd" or !$rept) echo $hd="Summary Payment of $dcat on ".date("l - jS \of M Y", mktime(0,0,0,$m1,$d,$y)); 
			elseif ($rept=="mm") echo $hd="Payment of $dcat in the Month of $m, $y"; 
			elseif ($rept=="yy") echo $hd="Payment of $dcat in the Year $y"; 
			elseif ($rept=="aa") echo $hd="Overall Payment of $dcat till date"; 
			elseif ($rept=="ww")
			{
...
<?php
	...
	if($num_results>=1)
	{
		for($i=1; $i<=$num_results; $i++) 
		{
			...
			echo "<td><a href='view_item_ordered.php?id=$id' title='Tel: $phone \nAddress: $address' target='_blank'>$customer</td>";
		...
		<tr bgcolor="green" class="textonly3">
		  ...
		  <td align="center"><b><?=number_format($total_dept,2)?></b></td>
        </tr>
...
?>
      ...
      <table width="147" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="43" height="25" bgcolor="#FFFFFF"><a href="print_debt_payment.php?rept=<?php echo $rept;?>&amp;d=<?php echo $d;?>&amp;m1=<?php echo $m1;?>&amp;y=<?php echo $y;?>&amp;hd=<?php echo $hd;?>&amp;start=<?php echo $start;?>&amp;end=<?php echo $end;?>&amp;cat=<?php echo $cat;?>&amp;item_id=<?php echo $item_id;?>&amp;st=<?php echo $st;?>" target="_blank"><img src="images/Preview-icon.png" alt="Preview in Printable Format" width="42" height="42" border="0" /></a></td>
