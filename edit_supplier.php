...
if($Submit=="Update Supplier")
{

	$dat=date('Y-m-d');
	$result=mysql_query("update supplier set dat='$dat',company='$company',address='$address',contact='$contact',phone='$phone',email='$email' where id='$id'");
	$msg="Supplier Detail has been successfully updated!"; 
...
<table width="100%" height="181" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <td height="13" valign="middle" class="textonly3"><p align="center" class="title style6"><strong>Edit Supplier Details         </strong></p>
          <hr /></td>
  </tr>
  <tr>
        ...
        <table width="441" height="270" border="0" align="center" cellpadding="0" cellspacing="0" class="textonly3">
          ...
          <tr>
            ...
            <td valign="middle"><div align="left">
              <input name="Submit" type="submit" class="inputs-focus" value="Update Supplier" />
            </div></td>
          </tr>
        </table>
        <p>&nbsp;</p>
