...
<table width="100%" height="181" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="157" align="center" valign="top"><form id="form1" name="form1" method="post" action="main.php?page=r_good_ordered">
	  ...
	  <?php 
				...
				elseif($cat and $item_id) 
					{
						if($rept=="aa") $add_this="where item_id='$item_id' and ord_by='$cat'";
						else $add_this="and item_id='$item_id' and ord_by='$cat'";
...
<?php
	...
	if($num_results>=1)
	{
		...
		echo "<tr bgcolor='#00CC66' title='- Total Discount: N$agg_discount \n- Total Debt: N$agg_dept \n- Total Payment (No Discount): N$agg_original_total'>"; ?>
		  ...
		  <td align="center" bgcolor="#00CC66"><b><?php echo number_format($agg_total_sales,2);?></b></td>
          <td align="center" bgcolor="#00CC66"><b><?php echo number_format($total_paid,2);?></b></td>
        </tr>
...
?>
      ...
      <table width="147" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="43" height="25" bgcolor="#FFFFFF"><a href="print_item_ordered.php?rept=<?php echo $rept;?>&amp;d=<?php echo $d;?>&amp;m1=<?php echo $m1;?>&amp;y=<?php echo $y;?>&amp;hd=<?php echo $hd;?>&amp;start=<?php echo $start;?>&amp;end=<?php echo $end;?>&amp;cat=<?php echo $cat;?>&amp;item_id=<?php echo $item_id;?>&amp;st=<?php echo $st;?>" target="_blank"><img src="images/Preview-icon.png" alt="Preview in Printable Format" width="42" height="42" border="0" /></a><a href="print_setup_item.php?download=excel" target="_blank"></a></td>
