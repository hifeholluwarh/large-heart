    ...
    <td height="157" align="center" valign="top"><form id="form1" name="form1" method="post" action="">
      ...
      <table width="95%" height="26" border="1" align="center" cellpadding="5" cellspacing="0">
        <tr bgcolor="green" class="textonly3">
		  ...
		  <td align="center" bgcolor="#000000"><div align="center" class="style9"><strong>Material Cost(#)</strong></div></td>
...
<?php
	...
	if($num_results>=1)
	{
		for($i=1; $i<=$num_results; $i++) 
		{
			...
			$total_amount=$rows["qty"]*$area*$rows["price"];
			echo "<td>".number_format($total_amount)."</td></tr>";
		...
		<tr bgcolor="green" class="textonly3">
		  ...
		  <td align="center"><b><?php echo number_format($total_sales,2);?></b></td>
        </tr>
...
?>
      ...
      <table width="147" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="43" height="25" bgcolor="#FFFFFF"><a href="print_cost_summary.php?rept=<?php echo $rept;?>&amp;d=<?php echo $d;?>&amp;m1=<?php echo $m1;?>&amp;y=<?php echo $y;?>&amp;hd=<?php echo $hd;?>&amp;start=<?php echo start;?>&amp;end=<?php echo $end;?>&amp;cat=<?php echo $cat;?>&amp;item_id=<?php echo $item_id;?>&amp;st=<?php echo $st;?>" target="_blank"><img src="images/Preview-icon.png" alt="Preview in Printable Format" width="42" height="42" border="0" /></a><a href="print_setup_item.php?download=excel" target="_blank"></a></td>
